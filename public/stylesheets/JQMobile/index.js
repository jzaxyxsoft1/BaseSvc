	...
	$( document ).on( "mobileinit", function(){
		$.widget( "mobile.h2linker", $.mobile.widget, {
			...
			_create:function(){
				var self = this,
					bodyid = "ui-page-top",
					panel = "<div data-role='panel' class='jqm-nav-panel jqm-quicklink-panel' data-position='right' data-display='overlay' data-theme='c'><ul data-role='listview' data-inset='false' data-theme='c' data-divider-theme='c' data-icon='false' class='jqm-list'><li data-role='list-divider'>Jump to section</li></ul></div>",
					first = true,
